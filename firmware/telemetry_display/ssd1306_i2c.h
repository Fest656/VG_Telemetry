 ...
 * This file declares functions used to transmit commands and buffers to the display,
 * as well as basic text and shape rendering functions.
 * This header file was created based upon the offical Raspberry Pi Pico I2C examples
*/
...
// Calculates the length of the render area buffer.
...
// Configures and toggles horizontal scrolling on the display.
void SSD1306_scroll(bool on);

// Updates the specified render area of the display with the given buffer.
void render(uint8_t *buf, struct render_area *area);

// Writes a string to the frame buffer at the specified coordinates.
